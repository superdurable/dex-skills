...
The baseline examples use `dex-sdk = "=0.3.1"` and require Rust 1.97 or newer. Do not blindly copy that dependency into an existing application: inspect its `Cargo.toml` and `Cargo.lock`, then consult [versioning](versioning.md). The published examples start a local Dex server, Worker, and HTTP controller with:
...
[Runnable source](https://github.com/superdurable/dex/blob/4881ef2c2acd1c234e2c91320443fdffcd034f2c/examples/rust/src/primitives/timer/flow.rs)
...
[Runnable source](https://github.com/superdurable/dex/blob/4881ef2c2acd1c234e2c91320443fdffcd034f2c/examples/rust/src/primitives/mod.rs)
