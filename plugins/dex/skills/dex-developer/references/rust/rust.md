...
The baseline examples use `dex-sdk = "=0.5.0"` and require Rust 1.97 or newer. Do not blindly copy that dependency into an existing application: inspect its `Cargo.toml` and `Cargo.lock`, then consult [versioning](versioning.md). The published examples start a local Dex server, Worker, and HTTP controller with:
...
[Runnable source](https://github.com/superdurable/dex/blob/ffe799a3bc22b373e8c952f4bb9eb79cc302bc34/examples/rust/src/primitives/timer/flow.rs)
...
[Runnable source](https://github.com/superdurable/dex/blob/ffe799a3bc22b373e8c952f4bb9eb79cc302bc34/examples/rust/src/primitives/mod.rs)
