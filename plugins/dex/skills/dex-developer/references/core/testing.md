...
- Publish Channel and ChannelMap messages and verify ordering, single consumption, stale message IDs, and terminal rejection.
...
- Lose or reconnect a Stream consumer and recover canonical state from Attributes.
