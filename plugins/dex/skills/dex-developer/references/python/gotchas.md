...
Use the pinned [typecheck contracts](https://github.com/superdurable/dex/blob/d5529248f14ae098d2324a247c80c48935f33a1e/sdk-python/tests/typecheck_contracts.py) and runnable examples rather than remembered names.
