...
[Pinned runnable source](https://github.com/superdurable/dex/blob/4881ef2c2acd1c234e2c91320443fdffcd034f2c/examples/python/dex_examples/primitives/heartbeat/heartbeat_flow.py)
...
Use summary/status for current state, history for causality, Attributes for business state, Streams for progress, and metrics for rates/saturation. Track attempt duration/count, exhaustion, timeout handlers, RPC conflicts, Channel backlog, Stream lag, Worker reachability, and BlobCache errors.

For a stall: identify Flow/run; inspect latest history and active attempt; verify registered types; verify Dex reaches advertised Worker target; inspect exception chain. The pinned [Client API example](https://github.com/superdurable/dex/blob/4881ef2c2acd1c234e2c91320443fdffcd034f2c/examples/python/dex_examples/primitives/client-apis/controller.py) shows supported reads.
