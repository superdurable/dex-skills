...
Use this page first for Python. The [baseline project](https://github.com/superdurable/dex/blob/a1f5f538f021666a8d9fee630af8580a20c313c0/examples/python/pyproject.toml) selects `dex-python-sdk==0.6.0`; check `pyproject.toml`/lockfile and installed metadata before relying on baseline syntax.
...
[Pinned runnable source](https://github.com/superdurable/dex/blob/a1f5f538f021666a8d9fee630af8580a20c313c0/examples/python/dex_examples/primitives/flow/example_flow.py)
