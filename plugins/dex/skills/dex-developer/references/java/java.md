...
Use this page first for Java application work. Then load the topic page that matches the task. The [baseline build](https://github.com/superdurable/dex/blob/4881ef2c2acd1c234e2c91320443fdffcd034f2c/examples/java/build.gradle) uses `io.superdurable:dex-sdk:0.3.1`, Spring Boot, and JDK 17 or newer. The application's Gradle or Maven lockfile remains authoritative.
...
[Pinned runnable source](https://github.com/superdurable/dex/blob/4881ef2c2acd1c234e2c91320443fdffcd034f2c/examples/java/src/main/java/io/superdurable/dex/primitives/flow/ExampleFlow.java)
...
[Pinned Step source](https://github.com/superdurable/dex/blob/4881ef2c2acd1c234e2c91320443fdffcd034f2c/examples/java/src/main/java/io/superdurable/dex/primitives/flow/ExampleFlow.java)
<!-- dex-source: examples/java/src/main/java/io/superdurable/dex/primitives/flow/ExampleFlow.java -->
```java
...
[Pinned bootstrap source](https://github.com/superdurable/dex/blob/4881ef2c2acd1c234e2c91320443fdffcd034f2c/examples/java/src/main/java/io/superdurable/dex/config/DexConfig.java)
...
Add `io.superdurable:dex-sdk:<resolved-version>` to Gradle or Maven. Application adapters call the injected Client to start a registered Flow, publish Channels, invoke an RPC stub, or wait for terminal status.
