...
Use this page first for Java application work. Then load the topic page that matches the task. The [baseline build](https://github.com/superdurable/dex/blob/d7b1d915bca9f2d82431d536b3adfbbc44497be9/examples/java/build.gradle) uses `io.superdurable:dex-sdk:0.3.1`, Spring Boot, and JDK 17 or newer. The application's Gradle or Maven lockfile remains authoritative.
...
[Pinned runnable source](https://github.com/superdurable/dex/blob/d7b1d915bca9f2d82431d536b3adfbbc44497be9/examples/java/src/main/java/io/superdurable/dex/primitives/flow/ExampleFlow.java)
...
[Pinned Step source](https://github.com/superdurable/dex/blob/d7b1d915bca9f2d82431d536b3adfbbc44497be9/examples/java/src/main/java/io/superdurable/dex/primitives/flow/ExampleFlow.java)
<!-- dex-source: examples/java/src/main/java/io/superdurable/dex/primitives/flow/ExampleFlow.java -->
```java
...
[Pinned bootstrap source](https://github.com/superdurable/dex/blob/d7b1d915bca9f2d82431d536b3adfbbc44497be9/examples/java/src/main/java/io/superdurable/dex/config/DexConfig.java)
