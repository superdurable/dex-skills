...
Use this page first for Java application work. Then load the topic page that matches the task. The [baseline build](https://github.com/superdurable/dex/blob/sdk-go/v0.10.2/examples/java/build.gradle) uses `io.superdurable:dex-sdk:0.6.0`, Spring Boot, and JDK 17 or newer. The application's Gradle or Maven lockfile remains authoritative.
...
[Pinned runnable source](https://github.com/superdurable/dex/blob/sdk-go/v0.10.2/examples/java/src/main/java/io/superdurable/dex/primitives/flow/ExampleFlow.java)
...
[Pinned Step source](https://github.com/superdurable/dex/blob/sdk-go/v0.10.2/examples/java/src/main/java/io/superdurable/dex/primitives/flow/ExampleFlow.java)
<!-- dex-source: examples/java/src/main/java/io/superdurable/dex/primitives/flow/ExampleFlow.java -->
```java
...
[Pinned bootstrap source](https://github.com/superdurable/dex/blob/sdk-go/v0.10.2/examples/java/src/main/java/io/superdurable/dex/config/DexConfig.java)
