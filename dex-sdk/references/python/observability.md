...
[Pinned runnable source](https://github.com/superdurable/dex/blob/sdk-go/v0.11.3/examples/python/dex_examples/primitives/heartbeat/heartbeat_flow.py)
