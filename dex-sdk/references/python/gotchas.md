...
Use the pinned [typecheck contracts](https://github.com/superdurable/dex/blob/sdk-go/v0.10.2/sdk-python/tests/typecheck_contracts.py) and runnable examples rather than remembered names.
